...
const conditionStatements = [
  ...
  { propertyName: 'totalCurrentAssets', indexPosition: 1, pattern: 'E25.Total assets (E18+E19+E20+E21+E22+E23+E24)' },
 ...
 * @name pdfParser_ITR_4_2020_21 
 * @param {Object} result 
 */
const pdfParser_ITR_4_2020_21 = (finalResult) => {
  ...
  try {
    ...
    ITR4.totalCurrentAssets = Number(totalCurrentAssets) - Number(currentAssets)
    ...
    logger.error(`Issue with parsing ITR - 4 2020_21 with error : ${err}`);
    return { message: 'Issue with parsing ITR - 4 2020_21', isValidITRInfo: false };
  }
}

module.exports = { pdfParser_ITR_4_2020_21 }